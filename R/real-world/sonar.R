...
# define the priors
prior = c(
  prior(horseshoe(df = sonar_df, scale_slab = sonar_scale_slab, 
                  par_ratio = sonar_par_ratio), 
        class = 'b'),
...
out = run_forward_selection(
  ...
  n=n,
  n_test=n_test)
print("R2D2 forward search done!")
...
out_normal = run_forward_selection(
  ...
  n=n,
  n_test=n_test)
print("Normal forward search done!")
...
out_projpred = run_projpred_varsel(
  ...
  n=n,
  n_test=n_test)
print("Projpred forward search done!")
